			...
			<div class="col-md-12">				
				<?php if ( is_single() ) : ?>
					...
					<div class="single-post-meta row">
						<div class="col-md-6 post-meta-infor">
							<i class="icon-calendar"></i>&nbsp;<?php the_date('Y-m-d', '<time>', '</time>'); ?>&nbsp;&nbsp;
							<i class="icon-user"></i>&nbsp;<?php the_author(); ?>&nbsp;&nbsp;
							<i class="icon-tag"></i>&nbsp;<?php echo javo_get_cat($post->ID, "category");?>&nbsp;&nbsp;
						...
						<div class="col-md-6 text-right post-social">
				...
				<?php else : ?>
					<div class="entry-content">
						...
						<!-- <?php echo javo_str_cut( get_the_excerpt(), 300);?> -->
