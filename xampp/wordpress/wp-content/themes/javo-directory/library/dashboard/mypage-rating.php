							...
							<div class="panel-heading">								
								...
								<div class="row">
									<div class="col-md-11 my-page-title">
										<?php _e('My Ratings List', 'javo_fr');?>
									</div> <!-- my-page-title -->
												...
												<div class="row">
													...
													<div class="col-md-6 pull-right">
														<div class="row content-panel-button-list" align="right">
															...
															<a class="btn btn-warning btn-circle mypage-tooltips javo-this-rating-edit" title="<?php _e('Edit Item', 'javo_fr'); ?>" data-post="<?php the_ID();?>"><i class="glyphicon glyphicon-pencil"></i></a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php _e('Edit Rating', 'javo_fr');?></h4>
			</div>
