								...
								<div class="row">
									<div class="col-md-12">
										<form method="post" action="<?php echo site_url('wp-login.php?action=lostpassword', 'login_post') ?>" class="wp-user-form">
											<div>
												<h3 class='tab-inner-titles'><i class="glyphicon glyphicon-lock"></i><?php _e('Change Password', 'javo_fr');?></h3>
												<div class="form-group left-inner-addon">
													<input type="email" name="user_pass" id="user_login" class="input form-control" value="" size="20" placeholder="Registered Email Address">
												</div> <!-- form-group -->
											</div>
