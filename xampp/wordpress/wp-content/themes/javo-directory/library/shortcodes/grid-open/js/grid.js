...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$details = $( '<div class="og-details"></div>' ).append( this.$title, this.$rating, this.$description, this.$href );
		...
		update : function( $item ) {
			...
			var $itemEl = this.$item.children( 'a' ),
				eldata = {
					...
					rating : $itemEl.data( 'rating' ),
				};

			this.$title.html( eldata.title );
			this.$rating.html( eldata.rating );
