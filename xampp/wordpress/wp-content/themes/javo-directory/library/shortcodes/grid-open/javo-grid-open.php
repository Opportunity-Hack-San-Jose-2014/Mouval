...
class javo_grid_open{
	...
	public function javo_grid_open_callback($atts, $content=""){
		global $javo_tso;		
		wp_enqueue_style( 'javo-grid_open-defaul-css', JAVO_THEME_DIR."/library/shortcodes/grid-open/css/default.css", '1.0' );
		wp_enqueue_style( 'javo-grid_open-component-css', JAVO_THEME_DIR."/library/shortcodes/grid-open/css/component.css", '1.0' );
