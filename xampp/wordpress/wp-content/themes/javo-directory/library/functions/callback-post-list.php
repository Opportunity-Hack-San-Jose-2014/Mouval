...
function javo_post_list_callback(){
	// Wordpress Queries
	global $wp_query, $javo_tso, $javo_favorite;
	...
	$p						= isset($_POST['post_id']) ? $_POST['post_id'] : NULL ;
	$item					= ($post_type == 'item')? 'act' : false;
	$ppp					= $_POST['ppp'];
	...
	if((int)$p > 0 ) $args['p'] = $_POST['post_id'];
		...
		<div class="row javo-item-grid-listing">
			...
			if( $posts->have_posts() ){
				while($posts->have_posts() ){
					...
					$meta = Array(
						'strong'=> $javo_meta_query->cat('item_category', 'No Category')
						, "featured"=> $javo_meta_query->cat('item_location', 'No Location')
					);
					?>
						...
						<div class="panel panel-default panel-relative">
							...
							if(!empty($detail_images)):
								...
								?>
									...
									<?php echo '<ul class="slides list-unstyled">';
			...
			if( $posts->have_posts() ){
				while($posts->have_posts() ){
					...
					<div class="row pretty_blogs" id="mini-album-listing">
						<div class="col-md-4 blog-thum-box">
							<?php
							$detail_images = (Array)@unserialize(get_post_meta(get_the_ID(), "detail_images", true));
							$detail_images[] = get_post_thumbnail_id( get_the_ID() );
							if(!empty($detail_images)):
								...
								<div class="javo_detail_slide">
									<ul class="slides list-unstyled">
										...
										foreach($detail_images as $index => $image){
											$javo_this_image_meta	= wp_get_attachment_image_src($image, 'full');
											$javo_this_image		= $javo_this_image_meta[0];
											printf('<li><u href="%s">%s</u></li>', $javo_this_image, wp_get_attachment_image($image, "javo-box-v", true, Array('class'=>'javo-item-blog-list-radius-img')));
										};
										?>
									</ul>
						...
						<div class="col-md-8 blog-meta-box">
								...
								<div class="col-md-12 javo-blog-meta-tags">
									...
									<div class="pull-left">
										<ul class="pagination pagination-sm no-margin pagination-dark">
											...
											<li class="active"><a href="#"><?php _e('Event(s)', 'javo_fr');?></a></li>
										</ul>
									</div>
									<div class="pull-left">
										<ul class="pagination pagination-sm no-margin pagination-dark">
											<li><a href="#" class="javo-accent bold-number"><?php echo $meta['column4'];?></a></li>
											<li class="active"><a href="#"><?php _e('Review(s)', 'javo_fr');?></a></li>
										</ul>
									</div>
					...
					while( $posts->have_posts() ){
						...
						$javo_meta_string = Array(
							...
							, 'type'			=> sprintf('<span class="glyphicon glyphicon-user"></span> %s ( %s )'
													...
													, date('M d, Y', strtotime( get_the_date() ) )
												)
						);
						?>
						<div class="col-md-6 box-wraps">
							...
							<div class="main-box item-wrap1">
								...
								<ul class="list-group">
									<li class="list-group-item">
										<div class="row">
											<div class="col-md-6 javo-box-listing-meta">
								...
								while( $posts->have_posts() ){
									...
									<div class="panel panel-default  item-list-box-listing">
										...
										<div class="panel-footer options-wrap">
											<div class="row">
												<ul class="options">
													<li class="col-md-6 col-sm-6 col-xs-6"><i class="javo-con category"></i>&nbsp;<?php echo javo_get_cat(get_the_ID(), 'item_category', 'No Category');?></li>
													<li class="col-md-6 col-sm-6 col-xs-6 text-right"><i class="javo-con location"></i>&nbsp;<?php echo javo_get_cat(get_the_ID(), 'item_location', 'No Location');?></li>
												</ul>
											</div>
										</div><!-- panel-footer -->
										<div class="javo-left-overlay">
											<div class="javo-txt-meta-area">
												<?php echo javo_get_cat(get_the_ID(), 'item_category', 'No Category');?>
											</div> <!-- javo-txt-meta-area -->
											<div class="corner-wrap">
												<div class="corner"></div>
												<div class="corner-background"></div>
	...
	$result = Array(
		"result"=> "success",
		"html"=> ( count( $posts ) > 0? $content: $blank_content),
		"markers"=>$markers
	);
