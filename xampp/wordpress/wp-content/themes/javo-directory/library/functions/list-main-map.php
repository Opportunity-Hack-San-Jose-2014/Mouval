							...
							<div class="thumbnail item-list-box-map">
								<div class="thumb-wrap">
										...
										<div class="javo-left-overlay">
											<div class="javo-txt-meta-area admin-color-setting"><?php echo javo_get_cat(get_the_ID(), 'item_category', 'No Category');?>	</div> <!-- javo-txt-meta-area -->
										...
										<div class="rate-icons">
											<div class="col-md-2"><div class="col-md-12 javo-rating-registed-score" data-score="<?php echo $javo_rating->parent_rating_average;?>"></div></div>
										</div> <!-- rate-icons -->
										<div class="intro">
										...
										<div class="three-inner-button">
											<a class="javo-hmap-marker-trigger three-inner-move" data-id="<?php echo 'mid_'.get_the_ID();?>" data-post-id="<?php the_ID();?>">Move</a>
											<a href="<?php the_permalink(); ?>" class="three-inner-detail">Detail</a>
											<a href="<?php the_permalink(); ?>" target="_brank" class="three-inner-popup">Popup</a>
								...
								<div class="caption">													
									...
									<div class="row">
										...
										<div class="col-xs-12 col-md-6">
											<div class="row">
												<div class="col-md-12">
													<?php echo strtoupper(javo_get_cat( get_the_ID(), 'item_location', 'No Location')); ?>
												</div><!-- col md 8 -->
											</div><!-- Row -->
										</div>
										<div class="col-xs-12 col-md-6">
	...
	<div class="javo_somw_info panel">
		<div class="des">
			<ul class="list-unstyled">
				...
				<li><div class="prp-meta"><?php echo $javo_meta_query->get('address');?></div></li>
			</ul>
		</div> <!-- des -->
		...
		<div class="pics">
			...
			<div class="img-in-text"><?php echo javo_get_cat(get_the_ID(), 'item_category', 'No Category');?></div>
			<div class="javo-left-overlay">
				<div class="javo-txt-meta-area custom-bg-color-setting"><?php echo javo_get_cat(get_the_ID(), 'item_location', 'No Location');?></div> <!-- javo-txt-meta-area -->
