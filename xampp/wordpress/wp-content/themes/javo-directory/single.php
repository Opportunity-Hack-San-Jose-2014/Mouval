		...
		<div class="row">
			...
			<div class="col-md-9 main-content-wrap">
				...
				<nav class="nav-single">
					...
					<?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '<i class="icon-arrow-left7"></i>', 'Previous post link', 'javo_fr' ) . '</span> Prev' ); ?>
					</span>
					<span class="nav-next">
					<?php next_post_link( '%link', 'Next <span class="meta-nav">' . _x( '<i class="icon-arrow-right7"></i>', 'Next post link', 'javo_fr' ) . '</span>' ); ?>
					</span>
				</nav><!-- .nav-single -->
