...
$output .= sprintf('<div class="atat %s" %s >', $css_class, $style);
$output .= sprintf('<div></div>
	<div class="javo-vc-row%s" data-target="%s" data-content-full-width="%s" data-background-type="%s" data-background-color="%s" data-background="%s" data-delay="%s" data-box-shadow="%s" data-box-shadow-color="%s"></div>'
