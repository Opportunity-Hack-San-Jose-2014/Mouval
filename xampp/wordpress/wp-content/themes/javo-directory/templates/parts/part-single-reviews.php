<?php echo apply_filters('javo_shortcode_title', __('Reviews', 'javo_fr'), get_the_title() ); ?>
<div class="row review-wrap">
	<div class="col-md-12">
		<div class="javo-single-review-more-content">
			<div class="text-right">
				<?php if( is_user_logged_in() ){ ?>
					<form method="post" action="<?php echo home_url('add-review/'.wp_get_current_user()->user_login);?>">
						<p class="text-right">
		...
		<div class="javo-single-review-not-found-more-content hidden alert alert-light-gray text-center">
			...
			<p><?php _e('Not found any review.', 'javo_fr');?>	</p>
		</div>
