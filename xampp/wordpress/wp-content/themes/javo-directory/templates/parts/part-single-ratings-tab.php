<?php
global $javo_this_single_page_type, $javo_tso, $javo_animation_fixed;
...
<div class="total-rating">
	<div class="row total-rating-top-wrap">
		<div class="col-xs-12 col-md-6 javo-animation javo-left-to-right-999 <?php echo $javo_animation_fixed;?>">
		...
		<div class="col-xs-12 col-md-6 javo-animation javo-right-to-left-999 <?php echo $javo_animation_fixed;?>">
			<div class="well well-sm">
				<div class="total-rating-title">
