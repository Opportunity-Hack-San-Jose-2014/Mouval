...
<?php
if (isset($_GET["message"]) == "get_message") 
{
  $app_info = file_get_contents('http://{Your Website}/api.php?=get_app&id=' . $_GET["id"]);
...
{
  $app_list = file_get_contents('http://{Your Website}/api.php?action=get_categories');
